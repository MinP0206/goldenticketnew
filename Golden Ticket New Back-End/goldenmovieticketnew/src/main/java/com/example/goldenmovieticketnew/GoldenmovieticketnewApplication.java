...
import com.example.goldenmovieticketnew.payload.GetDateFormatedSingleton;
...
//		movie.setCreatedDate(GetDateFormatedSingleton.getInstance().getDate("hh:mm:ss,EEE, dd/MM/yyyy"));
//		movie.setLastModifiedDate(GetDateFormatedSingleton.getInstance().getDate("EEE, dd/MM/yyyy"));
